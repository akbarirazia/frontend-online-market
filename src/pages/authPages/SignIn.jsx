    ...
    <Container>
      ...
      >
        <div className='hidden md:flex flex-col justify-center flex-1 bg-white'>
          ...
          <Player
            src='https://lottie.host/ed7fa244-3aaf-480c-9020-b72bb9e1740f/lfmPKykFX5.json'
            background='#FFFFFF'
            speed='1'
          ...
          <h2 className='font-bold text-xl mb-3 mx-auto w-[70%]'>
            Here is your online local Market
          </h2>
          <p className='font-light text-md w-[70%] mx-auto'>
            Discover amazing deals and unique talents right in your
            neighborhood! Our marketplace connects you with listings of people
            within your area making it easy to get the services you need.
          </p>
        </div>
